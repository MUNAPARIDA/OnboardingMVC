...
function (_Emitter) {
  ...
  _createClass(HelloSign, [{
    ...
    value: function _applyVersion(params) {
      params.append('js_version', "2.9.0");
    }
    /**
...
_defineProperty(HelloSign, "version", "2.9.0");
